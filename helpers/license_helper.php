...
if (!defined('LICENSE_WEBHOOK_URL')) {
    define('LICENSE_WEBHOOK_URL', (string) env('LICENSE_WEBHOOK_URL', ''));
}
if (!defined('LICENSE_WEBHOOK_USER')) {
    define('LICENSE_WEBHOOK_USER', (string) env('LICENSE_WEBHOOK_USER', ''));
}
if (!defined('LICENSE_WEBHOOK_PASS')) {
    define('LICENSE_WEBHOOK_PASS', (string) env('LICENSE_WEBHOOK_PASS', ''));
}
