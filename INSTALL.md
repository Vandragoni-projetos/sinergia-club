> **LEGADO.** Para instalações novas, use **[docs/INSTALACAO_COMPLETA.md](docs/INSTALACAO_COMPLETA.md)** e o SQL **[database/install.sql](database/install.sql)**. Este arquivo permanece como histórico (Hostinger / fluxo antigo).
