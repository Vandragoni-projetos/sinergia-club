                ...
                recentUsersContainer.innerHTML = '';
                 if(data.recent_users && data.recent_users.length > 0) {
                    data.recent_users.forEach(user => {
                        ...
                        // Define badge style based on user type
                        let badgeClass = 'bg-blue-900/30 text-blue-300';
                        let badgeText = 'Cliente Final';
                        if (user.tipo === 'admin') {
                            badgeClass = 'bg-purple-900/30 text-purple-300';
                            badgeText = 'Admin';
                        } else if (user.tipo === 'infoprodutor') {
                            badgeClass = 'bg-green-900/30 text-green-300';
                            badgeText = 'Infoprodutor';
                        }
