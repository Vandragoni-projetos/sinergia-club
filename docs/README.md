...
**Instalação nova:** comece por **[INSTALACAO_COMPLETA.md](INSTALACAO_COMPLETA.md)** e execute **[database/install.sql](../database/install.sql)**. Checklist: **[CHECKLIST_POS_INSTALACAO.md](CHECKLIST_POS_INSTALACAO.md)**.

Os guias em `deploy/` e o `INSTALL.md` da raiz são **legado** (Hostinger / VPS anterior). Use-os só como referência complementar.
...
| Documento | Descrição |
|-----------|-----------|
| **[INSTALACAO_COMPLETA.md](INSTALACAO_COMPLETA.md)** | **Guia mestre** — instalação do zero (EasyPanel, banco, .env, webhooks, cron, PWA). |
| **[CHECKLIST_POS_INSTALACAO.md](CHECKLIST_POS_INSTALACAO.md)** | Checklist objetivo após subir a instância. |
| [../INSTALL.md](../INSTALL.md) | **LEGADO** — Hostinger / fluxo antigo. |
| [deploy/DEPLOY_VPS.md](deploy/DEPLOY_VPS.md) | **LEGADO** — VPS Ubuntu/Nginx. |
| [deploy/DEPLOY_HOSTINGER.md](deploy/DEPLOY_HOSTINGER.md) | **LEGADO** — Hostinger. |
| [deploy/DOC_INSTALACAO_E_ESTRUTURA.md](deploy/DOC_INSTALACAO_E_ESTRUTURA.md) | **LEGADO** — estrutura e funcionalidades. |
...
| [geral/PRECO_ORDER_BUMP.md](geral/PRECO_ORDER_BUMP.md) | Preço secundário de Order Bump (`preco_order_bump`): regra, migration, deploy, testes, rollback. |
