> **LEGADO.** Instalação nova: **[../INSTALACAO_COMPLETA.md](../INSTALACAO_COMPLETA.md)**. Este documento descreve estrutura e funcionalidades, não o processo canônico de instalação.
