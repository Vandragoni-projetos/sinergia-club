> **LEGADO.** Para instalações novas, use **[../INSTALACAO_COMPLETA.md](../INSTALACAO_COMPLETA.md)** e **[../../database/install.sql](../../database/install.sql)**. Este guia permanece como referência de VPS Ubuntu/Nginx.
